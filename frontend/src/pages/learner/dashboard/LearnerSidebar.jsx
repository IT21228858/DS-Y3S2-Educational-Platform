...
const LearnerSidebar = () => {
  ...
  const handleLinkClick = (content) => {
    ...
    navigate(`/learner?content=${content}`);
  };
  //
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li className="nav-item mt-2">
            <Link
              ...
              style={
                activeContent === "Courses" ? navLinkStyle : { color: "#000" }
              }
            >
              {/* show the user this will take them to the courses page using emoji */}
              📚 Courses
            </Link>
          </li>
        </ul>
